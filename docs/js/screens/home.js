 ...
 *
 *  화면이 열 개나 되면 어디부터 눌러야 할지 모릅니다. 그래서 커리큘럼의
...
(function (root) {
  ...
  const SCREENS = [
    ...
    ['bounce', '낙폭 반등', '많이 떨어진 종목이 정말 돌아오는지 셉니다. 버튼 하나면 되니 여기서 시작해도 좋습니다'],
    ['alpha', '알파 만들기', '나만의 식을 씁니다. 대회에서 제출하는 것이 이것입니다. 기준에 못 미치면 병목을 짚어 줍니다'],
    ...
    ['learn', '배우기', '알파 아이디어 26개, 흔한 함정, 실습 과제, IQC 로드맵, 용어집']
  ];
